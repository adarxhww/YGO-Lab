        ...
        <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
          <div className="flex h-[72px] items-center justify-between px-5 sm:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden h-9 w-9 items-center justify-center rounded-full bg-slate-100 text-sm font-bold sm:flex">
                DT
              </div>
            </div>
          </div>
          ...
          <section className="mt-6 rounded-2xl border border-slate-200 bg-slate-900 p-6 text-white">
            <div className="max-w-3xl">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-300">
                TradeCraft Sim is designed to combine
